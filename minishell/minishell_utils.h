...
/*   Updated: 2021/04/13 14:20:29 by aurelien         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
char			**selec_dest(t_parsing *parsing, char **line, int *p,
	t_utils *utils);
void			refresh_screen(char **print, char *prefix, t_utils *utils,
	int histo);
int				ft_print_prefix(int check, int	activate, char ***env,
	t_utils *utils);
...
int				ft_next_is_pipe(t_parsing info, char **env, t_utils *utils,
	int flag);
...
size_t			ft_doubletab_len(char **doubletable);
#endif
