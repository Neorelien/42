...
/*   Updated: 2020/12/22 18:53:53 by Aurelien         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void		ft_flag_point(int flag, int *size,
		char *arg_str, unsigned int *arg_value)
{
	int	i;
	int	arg_size;
...
static void		ft_is_zero_flag(unsigned int *arg_value,
		char *arg_str, int *size)
{
	int	arg_size;
...
static void		ft_just_size(int flag, char *arg_str,
		unsigned int *arg_value, int *size)
{
	int arg_size;
